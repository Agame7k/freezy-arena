...
func (web *Web) newHandler() http.Handler {
	...
	mux.HandleFunc("GET /fta", web.ftaHandler)
	mux.HandleFunc("GET /fta/websocket", web.ftaWebsocketHandler)
	mux.HandleFunc("GET /api/fta/events/current", web.ftaCurrentEventsApiHandler)
	mux.HandleFunc("GET /api/fta/matches", web.ftaMatchesApiHandler)
	mux.HandleFunc("GET /api/fta/matches/{matchId}/timeline", web.ftaTimelineApiHandler)
	mux.HandleFunc("GET /api/fta/teams/{teamId}", web.ftaTeamHistoryApiHandler)
	mux.HandleFunc("GET /api/fta/watchlist", web.ftaWatchlistApiHandler)
